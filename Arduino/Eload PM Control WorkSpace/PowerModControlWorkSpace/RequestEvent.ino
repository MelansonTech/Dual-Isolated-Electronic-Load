void requestEvent(void) {
  ...
  switch (MeaurementSelection) {
    ...
    case RMS_ADCReadingCurrent://send temp reading

      Wire1.write(int (RMS_Current.RMS) & 0xFF);
      Wire1.write(int (RMS_Current.RMS) >> 8 & 0xFF);
      break;

    case RMS_ADCReadingVolt://send temp reading

      Wire1.write(int (RMS_Volt.RMS) & 0xFF);
      Wire1.write(int (RMS_Volt.RMS) >> 8 & 0xFF);
      break;
